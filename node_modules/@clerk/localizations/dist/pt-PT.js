...
var ptPT = {
    ...
    membersPage: {
      ...
      alerts: {
        roleSetMigrationInProgress: {
          subtitle: "Estamos a atualizar as fun\xE7\xF5es dispon\xEDveis. Assim que terminar, poder\xE1 atualizar as fun\xE7\xF5es novamente.",
  ...
  signIn: {
    ...
    emailLinkMfa: {
      formSubtitle: "Utilize a liga\xE7\xE3o de verifica\xE7\xE3o enviada para o seu e-mail",
      resendButton: "N\xE3o recebeu a liga\xE7\xE3o? Reenviar",
    ...
    newDeviceVerificationNotice: "Est\xE1 a iniciar sess\xE3o a partir de um novo dispositivo. Estamos a solicitar verifica\xE7\xE3o para manter a sua conta segura.",
    noAvailableMethods: {
    ...
    web3Solana: {
      subtitle: "Selecione uma carteira abaixo para iniciar sess\xE3o",
      title: "Iniciar sess\xE3o com Solana"
    }
  },
  ...
  taskChooseOrganization: {
    alerts: {
      organizationAlreadyExists: "J\xE1 existe uma organiza\xE7\xE3o para o nome da empresa detetado ({{organizationName}}) e {{organizationDomain}}. Adira por convite."
    },
    chooseOrganization: {
    ...
    createOrganization: {
      ...
      formFieldInputPlaceholder__name: "A minha organiza\xE7\xE3o",
      formFieldInputPlaceholder__slug: "a-minha-organizacao",
      formFieldLabel__name: "Nome",
      formFieldLabel__slug: "Slug",
      subtitle: "Introduza os detalhes da sua organiza\xE7\xE3o para continuar",
      title: "Configurar a sua organiza\xE7\xE3o"
    },
    organizationCreationDisabled: {
      subtitle: "Contacte o administrador da sua organiza\xE7\xE3o para obter um convite.",
      title: "Deve pertencer a uma organiza\xE7\xE3o"
    },
    signOut: {
      actionLink: "Terminar sess\xE3o",
      actionText: "Sess\xE3o iniciada como {{identifier}}"
    }
  },
  taskResetPassword: {
  ...
  unstable__errors: {
    ...
    avatar_file_size_exceeded: "O tamanho do ficheiro excede o limite m\xE1ximo de 10 MB. Por favor, escolha um ficheiro mais pequeno.",
    avatar_file_type_invalid: "Tipo de ficheiro n\xE3o suportado. Por favor, carregue uma imagem JPG, PNG, GIF ou WEBP.",
    ...
    form_email_address_blocked: "Servi\xE7os de e-mail tempor\xE1rios n\xE3o s\xE3o suportados. Por favor, use o seu endere\xE7o de e-mail regular para criar uma conta.",
    ...
    form_password_or_identifier_incorrect: "A palavra-passe ou o endere\xE7o de e-mail est\xE1 incorreto. Tente novamente ou use outro m\xE9todo.",
    ...
    form_username_needs_non_number_char: "O seu nome de utilizador deve conter pelo menos um caractere n\xE3o num\xE9rico.",
    ...
    start: {
      ...
      web3WalletsSection: {
        ...
        web3SelectSolanaWalletScreen: {
          subtitle: "Selecione uma carteira Solana para ligar \xE0 sua conta.",
  ...
  web3SolanaWalletButtons: {
    ...
    noneAvailable: 'N\xE3o foram detetadas carteiras Solana Web3. Instale uma {{ solanaWalletsLink || link("wallet extension") }} com suporte Web3.'
  }
};
