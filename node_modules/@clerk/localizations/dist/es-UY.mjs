...
var esUY = {
  ...
  signIn: {
    ...
    web3Solana: {
      subtitle: "Selecciona una billetera abajo para iniciar sesi\xF3n",
  ...
  taskChooseOrganization: {
    ...
    createOrganization: {
      ...
      subtitle: "Ingres\xE1 los detalles de tu organizaci\xF3n para continuar",
      title: "Configurar tu organizaci\xF3n"
    },
    organizationCreationDisabled: {
      subtitle: "Contact\xE1 al administrador de tu organizaci\xF3n para obtener una invitaci\xF3n.",
      title: "Deb\xE9s pertenecer a una organizaci\xF3n"
    },
    signOut: {
  ...
  unstable__errors: {
    ...
    avatar_file_size_exceeded: "El tama\xF1o del archivo supera el l\xEDmite m\xE1ximo de 10 MB. Por favor, eleg\xED un archivo m\xE1s peque\xF1o.",
    avatar_file_type_invalid: "Tipo de archivo no compatible. Por favor, sub\xED una imagen JPG, PNG, GIF o WEBP.",
    ...
    form_email_address_blocked: "Los servicios de correo electr\xF3nico temporal no est\xE1n soportados. Por favor, us\xE1 tu direcci\xF3n de correo electr\xF3nico habitual para crear una cuenta.",
    ...
    form_password_or_identifier_incorrect: "La contrase\xF1a o la direcci\xF3n de correo electr\xF3nico es incorrecta. Intent\xE1 de nuevo o us\xE1 otro m\xE9todo.",
