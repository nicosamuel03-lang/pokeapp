...
var caES = {
  ...
  signIn: {
    ...
    emailCodeMfa: {
      formTitle: "Comprova el teu correu electr\xF2nic",
      resendButton: "No has rebut el codi? Reenvia",
      subtitle: "per continuar a {{applicationName}}",
      title: "Comprova el teu correu electr\xF2nic"
    },
    ...
    emailLinkMfa: {
      formSubtitle: "Utilitzeu l'enlla\xE7 de verificaci\xF3 enviat al vostre correu electr\xF2nic",
      resendButton: "No heu rebut l'enlla\xE7? Reenviar",
      subtitle: "per continuar a {{applicationName}}",
      title: "Comproveu el vostre correu electr\xF2nic"
    },
    ...
    newDeviceVerificationNotice: "Est\xE0s iniciant sessi\xF3 des d'un dispositiu nou. Demanem verificaci\xF3 per mantenir el compte segur.",
    noAvailableMethods: {
    ...
    web3Solana: {
      subtitle: "Selecciona una cartera a continuaci\xF3 per iniciar la sessi\xF3",
      title: "Inicia la sessi\xF3 amb Solana"
    }
  },
  ...
  signUp: {
    ...
    web3Solana: {
      subtitle: "Selecciona una cartera a continuaci\xF3 per registrar-te",
  ...
  taskChooseOrganization: {
    alerts: {
      organizationAlreadyExists: "Ja existeix una organitzaci\xF3 per al nom d'empresa detectat ({{organizationName}}) i {{organizationDomain}}. Uneix-te per invitaci\xF3."
    },
    chooseOrganization: {
      action__createOrganization: "Crear nova organitzaci\xF3",
      action__invitationAccept: "Unir-se",
      action__suggestionsAccept: "Sol\xB7licitar unir-se",
      subtitle: "Uniu-vos a una organitzaci\xF3 existent o creeu-ne una de nova",
      subtitle__createOrganizationDisabled: "Uniu-vos a una organitzaci\xF3 existent",
      suggestionsAcceptedLabel: "Pendent d'aprovaci\xF3",
      title: "Trieu una organitzaci\xF3"
    },
    createOrganization: {
      formButtonReset: "Cancel\xB7lar",
      formButtonSubmit: "Continuar",
      formFieldInputPlaceholder__name: "La meva organitzaci\xF3",
      formFieldInputPlaceholder__slug: "la-meva-organitzacio",
      formFieldLabel__name: "Nom",
      formFieldLabel__slug: "Slug",
      subtitle: "Introdu\xEFu els detalls de la vostra organitzaci\xF3 per continuar",
      title: "Configureu la vostra organitzaci\xF3"
    },
    organizationCreationDisabled: {
      subtitle: "Contacteu amb l'administrador de la vostra organitzaci\xF3 per obtenir una invitaci\xF3.",
      title: "Heu de pert\xE0nyer a una organitzaci\xF3"
    },
    signOut: {
      actionLink: "Tancar sessi\xF3",
      actionText: "Sessi\xF3 iniciada com a {{identifier}}"
    }
  },
  taskResetPassword: {
  ...
  unstable__errors: {
    ...
    avatar_file_size_exceeded: "La mida del fitxer supera el l\xEDmit m\xE0xim de 10 MB. Si us plau, tria un fitxer m\xE9s petit.",
    avatar_file_type_invalid: "El tipus de fitxer no \xE9s compatible. Si us plau, puja una imatge JPG, PNG, GIF o WEBP.",
    ...
    form_email_address_blocked: "Els serveis de correu electr\xF2nic temporal no estan suportats. Si us plau, utilitzeu la vostra adre\xE7a de correu electr\xF2nic habitual per crear un compte.",
    ...
    form_password_or_identifier_incorrect: "La contrasenya o l'identificador \xE9s incorrecte. Torna-ho a intentar o utilitza un altre m\xE8tode.",
    ...
    form_username_needs_non_number_char: "El vostre nom d'usuari ha de contenir almenys un car\xE0cter no num\xE8ric.",
    ...
    web3_signature_request_rejected: "Has rebutjat la sol\xB7licitud de signatura. Torna-ho a provar per continuar.",
    web3_solana_signature_generation_failed: "S'ha produ\xEFt un error en generar la signatura. Torna-ho a provar per continuar.",
    zxcvbn: {
  ...
  waitlist: {
    start: {
      actionLink: "Iniciar sessi\xF3",
      actionText: "Ja tens acc\xE9s?",
      formButton: "Unir-se a la llista d'espera",
      subtitle: "Introdueix la teva adre\xE7a de correu electr\xF2nic i t'avisarem quan el teu lloc estigui llest",
      title: "Unir-se a la llista d'espera"
    },
    success: {
      message: "Se't redirigir\xE0 aviat...",
      subtitle: "T'enviarem un missatge quan el teu lloc estigui llest",
      title: "Gr\xE0cies per unir-te a la llista d'espera!"
    }
  },
  web3SolanaWalletButtons: {
    connect: "Connecta amb {{walletName}}",
    continue: "Continua amb {{walletName}}",
    noneAvailable: `No s'han detectat carteres Web3 de Solana. Instal\xB7la una {{ solanaWalletsLink || link("wallet extension") }} compatible amb Web3.`
  }
};
