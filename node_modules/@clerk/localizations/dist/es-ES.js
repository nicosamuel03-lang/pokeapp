...
var esES = {
  ...
  badge__you: "Usted",
  billing: {
    addPaymentMethod__label: "A\xF1adir nuevo m\xE9todo de pago",
    ...
    cancelFreeTrialAccessUntil: "Tu prueba seguir\xE1 activa hasta el {{ date | longDate('es-ES') }}. Despu\xE9s perder\xE1s el acceso a las funciones de prueba. No se te cobrar\xE1 nada.",
    cancelFreeTrialTitle: "\xBFCancelar la prueba gratuita del plan {{plan}}?",
    cancelSubscription: "Cancelar suscripci\xF3n",
    cancelSubscriptionAccessUntil: "Puedes seguir usando las funciones de '{{plan}}' hasta el {{ date | longDate('es-ES') }}, despu\xE9s ya no tendr\xE1s acceso.",
    cancelSubscriptionNoCharge: "No se te cobrar\xE1 por esta suscripci\xF3n.",
    cancelSubscriptionPastDue: "Tu suscripci\xF3n finalizar\xE1 inmediatamente y perder\xE1s el acceso a todas las funciones del plan. Se te pedir\xE1 que pagues el importe pendiente en tu pr\xF3xima suscripci\xF3n.",
    cancelSubscriptionTitle: "\xBFCancelar la suscripci\xF3n {{plan}}?",
    cannotSubscribeMonthly: "No puedes suscribirte a este plan con pago mensual. Para suscribirte, debes elegir el pago anual.",
    cannotSubscribeUnrecoverable: "No puedes suscribirte a este plan. Tu suscripci\xF3n actual es m\xE1s cara que este plan.",
    checkout: {
      ...
      downgradeNotice: "Mantendr\xE1s tu suscripci\xF3n actual y sus funciones hasta el final del ciclo de facturaci\xF3n; despu\xE9s se te cambiar\xE1 a esta suscripci\xF3n.",
      emailForm: {
        subtitle: "Antes de completar la compra, debes a\xF1adir una direcci\xF3n de correo electr\xF3nico donde se enviar\xE1n los recibos.",
        title: "A\xF1adir direcci\xF3n de correo electr\xF3nico"
      },
      lineItems: {
        title__freeTrialEndsAt: "La prueba termina el",
        title__paymentMethod: "M\xE9todo de pago",
        title__statementId: "ID del extracto",
        title__subscriptionBegins: "La suscripci\xF3n comienza el",
        title__totalPaid: "Total pagado"
      },
      pastDueNotice: "Tu suscripci\xF3n anterior ten\xEDa un pago pendiente.",
      perMonth: "al mes",
      title: "Pago",
      title__paymentSuccessful: "\xA1Pago realizado con \xE9xito!",
      title__subscriptionSuccessful: "\xA1Todo listo!",
      title__trialSuccess: "\xA1La prueba se ha iniciado correctamente!",
      totalDueAfterTrial: "Total a pagar cuando termine la prueba en {{days}} d\xEDas"
    },
    credit: "Cr\xE9dito",
    creditRemainder: "Cr\xE9dito por el tiempo restante de tu suscripci\xF3n actual.",
    defaultFreePlanActive: "Actualmente est\xE1s en el plan gratuito",
    free: "Gratis",
    getStarted: "Empezar",
    ...
    paymentMethod: {
      ...
      dev: {
        anyNumbers: "Cualquier n\xFAmero",
        cardNumber: "N\xFAmero de tarjeta",
        cvcZip: "CVC, c\xF3digo postal",
        developmentMode: "Modo de desarrollo",
        expirationDate: "Fecha de caducidad",
        testCardInfo: "Informaci\xF3n de tarjeta de prueba"
      }
    },
    paymentMethods__label: "M\xE9todos de pago",
    popular: "Popular",
    pricingTable: {
      billingCycle: "Ciclo de facturaci\xF3n",
      included: "Incluido"
    },
    reSubscribe: "Volver a suscribirse",
    seeAllFeatures: "Ver todas las funciones",
    startFreeTrial: "Iniciar prueba gratuita",
    startFreeTrial__days: "Iniciar prueba gratuita de {{days}} d\xEDas",
    subscribe: "Suscribirse",
    subscriptionDetails: {
      beginsOn: "Comienza el",
      currentBillingCycle: "Ciclo de facturaci\xF3n actual",
      endsOn: "Finaliza el",
      firstPaymentAmount: "Importe del primer pago",
      firstPaymentOn: "Primer pago el",
      nextPaymentAmount: "Importe del pr\xF3ximo pago",
      nextPaymentOn: "Pr\xF3ximo pago el",
      ...
      trialStartedOn: "La prueba comenz\xF3 el"
    },
    subtotal: "Subtotal",
    switchPlan: "Cambiar a este plan",
    switchToAnnual: "Cambiar a anual",
    switchToAnnualWithAnnualPrice: "Cambiar a anual {{currency}}{{price}} / a\xF1o",
  ...
  organizationProfile: {
    ...
    billingPage: {
      ...
      paymentMethodsSection: {
        ...
        add: "A\xF1adir nuevo m\xE9todo de pago",
        addSubtitle: "A\xF1ade un nuevo m\xE9todo de pago a tu cuenta.",
        cancelButton: "Cancelar",
        formButtonPrimary__add: "A\xF1adir m\xE9todo de pago",
        formButtonPrimary__pay: "Pagar {{amount}}",
        payWithTestCardButton: "Pagar con tarjeta de prueba",
        removeMethod: {
          messageLine1: "{{identifier}} se eliminar\xE1 de esta cuenta.",
          messageLine2: "Ya no podr\xE1s usar este m\xE9todo de pago y cualquier suscripci\xF3n recurrente que dependa de \xE9l dejar\xE1 de funcionar.",
      ...
      start: {
        ...
        headerTitle__subscriptions: "Suscripci\xF3n"
      },
      statementsSection: {
        empty: "No hay facturas para mostrar",
        itemCaption__paidForPlan: "Pagado por el plan {{plan}} {{period}}",
        itemCaption__proratedCredit: "Cr\xE9dito proporcional por el tiempo no utilizado de la suscripci\xF3n anterior",
    ...
    membersPage: {
      ...
      alerts: {
        roleSetMigrationInProgress: {
          subtitle: "Estamos actualizando los roles disponibles. Una vez hecho esto, podr\xE1s actualizar los roles de nuevo.",
          title: "Los roles est\xE1n temporalmente bloqueados"
        }
      },
  ...
  signIn: {
    ...
    emailCodeMfa: {
      formTitle: "Revise su correo electr\xF3nico",
      resendButton: "\xBFNo recibi\xF3 un c\xF3digo? Reenviar",
      subtitle: "para continuar a {{applicationName}}",
      title: "Revise su correo electr\xF3nico"
    },
    ...
    newDeviceVerificationNotice: "Est\xE1s iniciando sesi\xF3n desde un dispositivo nuevo. Estamos pidiendo verificaci\xF3n para mantener tu cuenta segura.",
    noAvailableMethods: {
    ...
    web3Solana: {
      subtitle: "Selecciona una cartera abajo para iniciar sesi\xF3n",
      title: "Iniciar sesi\xF3n con Solana"
    }
  },
  ...
  taskChooseOrganization: {
    alerts: {
      organizationAlreadyExists: "Ya existe una organizaci\xF3n para el nombre de empresa detectado ({{organizationName}}) y {{organizationDomain}}. \xDAnete por invitaci\xF3n."
    },
    chooseOrganization: {
      action__createOrganization: "Crear nueva organizaci\xF3n",
      action__invitationAccept: "Unirse",
      action__suggestionsAccept: "Solicitar unirse",
      subtitle: "Unirse a una organizaci\xF3n existente o crear una nueva",
      subtitle__createOrganizationDisabled: "Unirse a una organizaci\xF3n existente",
      suggestionsAcceptedLabel: "Pendiente de aprobaci\xF3n",
      title: "Elegir una organizaci\xF3n"
    },
    createOrganization: {
      formButtonReset: "Cancelar",
      formButtonSubmit: "Continuar",
      formFieldInputPlaceholder__name: "Mi Organizaci\xF3n",
      formFieldInputPlaceholder__slug: "mi-organizacion",
      formFieldLabel__name: "Nombre",
      formFieldLabel__slug: "Identificador",
      subtitle: "Ingrese los detalles de su organizaci\xF3n para continuar",
      title: "Configurar su organizaci\xF3n"
    },
    organizationCreationDisabled: {
      subtitle: "Contacte al administrador de su organizaci\xF3n para obtener una invitaci\xF3n.",
      title: "Debe pertenecer a una organizaci\xF3n"
    },
    signOut: {
      actionLink: "Cerrar sesi\xF3n",
      actionText: "Sesi\xF3n iniciada como {{identifier}}"
    }
  },
  taskResetPassword: {
  ...
  unstable__errors: {
    ...
    avatar_file_size_exceeded: "El tama\xF1o del archivo supera el l\xEDmite m\xE1ximo de 10 MB. Por favor, elija un archivo m\xE1s peque\xF1o.",
    ...
    form_email_address_blocked: "Los servicios de correo electr\xF3nico temporal no est\xE1n soportados. Por favor, use su direcci\xF3n de correo electr\xF3nico regular para crear una cuenta.",
    ...
    form_password_or_identifier_incorrect: "La contrase\xF1a o la direcci\xF3n de correo electr\xF3nico es incorrecta. Int\xE9ntalo de nuevo o usa otro m\xE9todo.",
    ...
    form_username_needs_non_number_char: "Tu nombre de usuario debe contener al menos un car\xE1cter no num\xE9rico.",
    ...
    web3_signature_request_rejected: "Has rechazado la solicitud de firma. Int\xE9ntalo de nuevo para continuar.",
    web3_solana_signature_generation_failed: "Se produjo un error al generar la firma. Int\xE9ntalo de nuevo para continuar.",
    zxcvbn: {
    ...
    start: {
      ...
      web3WalletsSection: {
        ...
        web3SelectSolanaWalletScreen: {
          ...
          title: "A\xF1adir una cartera de Solana"
        }
      }
    },
    usernamePage: {
