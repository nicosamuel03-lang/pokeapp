...
var nbNO = {
    ...
    membersPage: {
      ...
      alerts: {
        roleSetMigrationInProgress: {
          subtitle: "Vi oppdaterer tilgjengelige roller. N\xE5r det er gjort, vil du kunne oppdatere roller igjen.",
          title: "Roller er midlertidig l\xE5st"
        }
      },
  ...
  signIn: {
    ...
    emailLinkMfa: {
      ...
      resendButton: "Har du ikke mottatt lenken? Send p\xE5 nytt",
      subtitle: "for \xE5 fortsette til {{applicationName}}",
    ...
    newDeviceVerificationNotice: "Du logger inn fra en ny enhet. Vi ber om verifisering for \xE5 holde kontoen din sikker.",
    noAvailableMethods: {
    ...
    web3Solana: {
      subtitle: "Velg en lommebok nedenfor for \xE5 logge inn",
  ...
  signUp: {
    ...
    web3Solana: {
      subtitle: "Velg en lommebok nedenfor for \xE5 registrere deg",
  ...
  taskChooseOrganization: {
    alerts: {
      organizationAlreadyExists: "En organisasjon eksisterer allerede for det oppdagede firmanavnet ({{organizationName}}) og {{organizationDomain}}. Bli med via invitasjon."
    },
    chooseOrganization: {
      action__createOrganization: "Opprett ny organisasjon",
      action__invitationAccept: "Bli med",
      action__suggestionsAccept: "Be om \xE5 bli med",
    ...
    createOrganization: {
      ...
      subtitle: "Skriv inn organisasjonsdetaljene dine for \xE5 fortsette",
      title: "Sett opp din organisasjon"
    },
    organizationCreationDisabled: {
      subtitle: "Kontakt organisasjonsadministratoren din for en invitasjon.",
      title: "Du m\xE5 tilh\xF8re en organisasjon"
    },
    signOut: {
      actionLink: "Logg ut",
  ...
  unstable__errors: {
    ...
    avatar_file_size_exceeded: "Filst\xF8rrelsen overskrider maksgrensen p\xE5 10 MB. Vennligst velg en mindre fil.",
    avatar_file_type_invalid: "Filtypen st\xF8ttes ikke. Vennligst last opp et JPG-, PNG-, GIF- eller WEBP-bilde.",
    ...
    form_email_address_blocked: "Midlertidige e-posttjenester st\xF8ttes ikke. Vennligst bruk din vanlige e-postadresse for \xE5 opprette en konto.",
    ...
    form_password_or_identifier_incorrect: "Passordet eller e-postadressen er feil. Pr\xF8v igjen eller bruk en annen metode.",
    ...
    form_username_needs_non_number_char: "Brukernavnet ditt m\xE5 inneholde minst ett ikke-numerisk tegn.",
    ...
    web3_signature_request_rejected: "Du avviste signaturforesp\xF8rselen. Pr\xF8v igjen for \xE5 fortsette.",
    web3_solana_signature_generation_failed: "Det oppstod en feil under generering av signaturen. Pr\xF8v igjen for \xE5 fortsette.",
    zxcvbn: {
    ...
    start: {
      ...
      web3WalletsSection: {
        ...
        web3SelectSolanaWalletScreen: {
          subtitle: "Velg en Solana-lommebok for \xE5 koble den til kontoen din.",
  ...
  waitlist: {
    start: {
      ...
      formButton: "Bli med p\xE5 ventelisten",
      subtitle: "Skriv inn e-postadressen din, s\xE5 gir vi deg beskjed n\xE5r plassen din er klar",
      title: "Bli med p\xE5 ventelisten"
    },
    success: {
      message: "Du vil bli omdirigert snart...",
      subtitle: "Vi tar kontakt n\xE5r plassen din er klar",
      title: "Takk for at du ble med p\xE5 ventelisten!"
    }
  },
  web3SolanaWalletButtons: {
    connect: "Koble til med {{walletName}}",
    continue: "Fortsett med {{walletName}}",
    noneAvailable: 'Ingen Solana Web3-lommeb\xF8ker ble funnet. Installer en Web3-st\xF8ttet {{ solanaWalletsLink || link("wallet extension") }}.'
  }
};
export {
  nbNO
