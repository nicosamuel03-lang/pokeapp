...
var frFR = {
  ...
  apiKeys: {
    ...
    copySecret: {
      ...
      formHint: "Pour des raisons de s\xE9curit\xE9, nous ne vous permettrons pas de la consulter \xE0 nouveau plus tard.",
  ...
  lastAuthenticationStrategy: "Utilis\xE9 la derni\xE8re fois",
  ...
  organizationProfile: {
    ...
    createDomainPage: {
      subtitle: "Ajoutez le domaine pour le v\xE9rifier. Les utilisateurs poss\xE9dant une adresse e-mail sur ce domaine peuvent rejoindre l'organisation automatiquement ou demander \xE0 y adh\xE9rer.",
    ...
    membersPage: {
      ...
      alerts: {
        roleSetMigrationInProgress: {
          subtitle: "Nous mettons \xE0 jour les r\xF4les disponibles. Une fois termin\xE9, vous pourrez de nouveau modifier les r\xF4les.",
          title: "Les r\xF4les sont temporairement verrouill\xE9s"
        }
      },
      detailsTitle__emptyRow: "Aucun membre",
      invitationsTab: {
        autoInvitations: {
          headerSubtitle: "Invitez des utilisateurs en connectant un domaine de messagerie \xE0 votre organisation. Toute personne s'inscrivant avec une adresse e-mail de ce domaine pourra rejoindre l'organisation.",
  ...
  signIn: {
    ...
    alternativeMethods: {
      ...
      actionText: "Aucune de ces m\xE9thodes ne fonctionne ?",
      blockButton__backupCode: "Utiliser un code de r\xE9cup\xE9ration",
    ...
    emailCodeMfa: {
      formTitle: "V\xE9rifiez votre messagerie",
      resendButton: "Vous n'avez pas re\xE7u de code ? Renvoyer",
      subtitle: "pour continuer vers {{applicationName}}",
      title: "V\xE9rifiez votre messagerie"
    },
    ...
    emailLinkMfa: {
      formSubtitle: "Utilisez le lien de v\xE9rification envoy\xE9 par e-mail",
      resendButton: "Vous n'avez pas re\xE7u de lien ? Renvoyer",
      subtitle: "pour continuer vers {{applicationName}}",
      title: "V\xE9rifiez votre messagerie"
    },
    ...
    newDeviceVerificationNotice: "Vous vous connectez depuis un nouvel appareil. Nous demandons une v\xE9rification pour s\xE9curiser votre compte.",
    noAvailableMethods: {
    ...
    web3Solana: {
      subtitle: "S\xE9lectionnez un portefeuille ci-dessous pour vous connecter",
  ...
  signUp: {
    ...
    emailLink: {
      ...
      verifiedSwitchTab: {
        ...
        title: "E-mail v\xE9rifi\xE9 avec succ\xE8s"
      }
    },
    enterpriseConnections: {
      subtitle: void 0,
    ...
    web3Solana: {
      subtitle: "S\xE9lectionnez un portefeuille ci-dessous pour vous inscrire",
  ...
  taskChooseOrganization: {
    alerts: {
      organizationAlreadyExists: void 0
    },
    chooseOrganization: {
    ...
    organizationCreationDisabled: {
      ...
      title: "Vous devez appartenir \xE0 une organisation"
    },
    signOut: {
  ...
  unstable__errors: {
    ...
    avatar_file_size_exceeded: "La taille du fichier d\xE9passe la limite maximale de 10 Mo. Veuillez choisir un fichier plus petit.",
    avatar_file_type_invalid: "Type de fichier non pris en charge. Veuillez t\xE9l\xE9charger une image JPG, PNG, GIF ou WEBP.",
    ...
    form_email_address_blocked: "Les services de messagerie temporaire ne sont pas pris en charge. Veuillez utiliser votre adresse e-mail habituelle pour cr\xE9er un compte.",
    ...
    form_password_or_identifier_incorrect: "Le mot de passe ou l'adresse e-mail est incorrect. R\xE9essayez ou utilisez une autre m\xE9thode.",
    ...
    form_username_needs_non_number_char: "Votre nom d'utilisateur doit contenir au moins un caract\xE8re non num\xE9rique.",
    ...
    passwordComplexity: {
      ...
      minimumLength: "au moins {{length}} caract\xE8res",
    ...
    web3_solana_signature_generation_failed: "Une erreur s'est produite lors de la g\xE9n\xE9ration de la signature. Veuillez r\xE9essayer pour continuer.",
    zxcvbn: {
  ...
  userButton: {
    ...
    action__manageAccount: "G\xE9rer mon compte",
  ...
  userProfile: {
    ...
    emailAddressPage: {
      ...
      title: "Ajouter une adresse e-mail",
      verifyTitle: "V\xE9rifier un e-mail"
    },
    ...
    profilePage: {
      ...
      successMessage: "Votre profil a \xE9t\xE9 mis \xE0 jour.",
    ...
    start: {
      ...
      web3WalletsSection: {
        ...
        web3SelectSolanaWalletScreen: {
          subtitle: "S\xE9lectionnez un portefeuille Solana \xE0 connecter \xE0 votre compte.",
  ...
  web3SolanaWalletButtons: {
    ...
    noneAvailable: 'Aucun portefeuille Solana Web3 d\xE9tect\xE9. Veuillez installer une {{ solanaWalletsLink || link("wallet extension") }} compatible Web3.'
  }
};
