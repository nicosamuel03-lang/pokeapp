...
var daDK = {
    ...
    membersPage: {
      ...
      alerts: {
        roleSetMigrationInProgress: {
          subtitle: "Vi opdaterer de tilg\xE6ngelige roller. N\xE5r det er gjort, vil du kunne opdatere roller igen.",
          title: "Roller er midlertidigt l\xE5st"
        }
      },
  ...
  signIn: {
    ...
    emailLinkMfa: {
      formSubtitle: "Brug bekr\xE6ftelseslinket, der er sendt til din e-mail",
    ...
    web3Solana: {
      subtitle: "V\xE6lg en wallet nedenfor for at logge ind",
  ...
  signUp: {
    ...
    start: {
      ...
      subtitle: "Forts\xE6t til {{applicationName}}",
      subtitleCombined: "Forts\xE6t til {{applicationName}}",
      title: "Opret din konto",
      titleCombined: "Opret din konto"
    },
    web3Solana: {
      subtitle: "V\xE6lg en wallet nedenfor for at tilmelde dig",
      title: "Tilmeld dig med Solana"
    }
  },
  socialButtonsBlockButton: "Forts\xE6t med {{provider|titleize}}",
  socialButtonsBlockButtonManyInView: void 0,
  taskChooseOrganization: {
    alerts: {
      organizationAlreadyExists: "Der findes allerede en organisation for det registrerede firmanavn ({{organizationName}}) og {{organizationDomain}}. Tilmeld dig via invitation."
    },
    chooseOrganization: {
      ...
      suggestionsAcceptedLabel: "Afventer godkendelse",
      title: "V\xE6lg en organisation"
    },
    createOrganization: {
      formButtonReset: "Annuller",
      formButtonSubmit: "Forts\xE6t",
      ...
      subtitle: "Indtast dine organisationsoplysninger for at forts\xE6tte",
      title: "Ops\xE6t din organisation"
    },
    organizationCreationDisabled: {
      subtitle: "Kontakt din organisationsadministrator for en invitation.",
      title: "Du skal tilh\xF8re en organisation"
    },
    signOut: {
      actionLink: "Log ud",
  ...
  unstable__errors: {
    ...
    avatar_file_size_exceeded: "Filst\xF8rrelsen overskrider den maksimale gr\xE6nse p\xE5 10 MB. V\xE6lg venligst en mindre fil.",
    avatar_file_type_invalid: "Filtypen underst\xF8ttes ikke. Upload venligst et JPG-, PNG-, GIF- eller WEBP-billede.",
    ...
    form_email_address_blocked: "Midlertidige e-mailtjenester underst\xF8ttes ikke. Brug venligst din almindelige e-mailadresse til at oprette en konto.",
    ...
    form_password_or_identifier_incorrect: "Adgangskoden eller e-mailadressen er forkert. Pr\xF8v igen eller brug en anden metode.",
    ...
    form_username_needs_non_number_char: "Dit brugernavn skal indeholde mindst \xE9t ikke-numerisk tegn.",
    ...
    web3_signature_request_rejected: "Du har afvist signaturanmodningen. Pr\xF8v igen for at forts\xE6tte.",
    web3_solana_signature_generation_failed: "Der opstod en fejl under generering af signaturen. Pr\xF8v igen for at forts\xE6tte.",
    zxcvbn: {
    ...
    start: {
      ...
      web3WalletsSection: {
        ...
        web3SelectSolanaWalletScreen: {
          subtitle: "V\xE6lg en Solana-wallet for at forbinde den til din konto.",
          title: "Tilf\xF8j en Solana-wallet"
        }
      }
    },
    usernamePage: {
  ...
  waitlist: {
    start: {
      ...
      subtitle: "Indtast din e-mailadresse, s\xE5 giver vi dig besked, n\xE5r din plads er klar",
      title: "Tilmeld dig ventelisten"
    },
    success: {
      message: "Du vil blive omdirigeret snart...",
      subtitle: "Vi kontakter dig, n\xE5r din plads er klar",
      title: "Tak fordi du tilmeldte dig ventelisten!"
    }
  },
  web3SolanaWalletButtons: {
    connect: "Forbind med {{walletName}}",
    continue: "Forts\xE6t med {{walletName}}",
    noneAvailable: 'Ingen Solana Web3-wallets fundet. Installer venligst en Web3-underst\xF8ttet {{ solanaWalletsLink || link("wallet extension") }}.'
  }
};
