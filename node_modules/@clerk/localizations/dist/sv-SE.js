...
var svSE = {
    ...
    membersPage: {
      ...
      alerts: {
        roleSetMigrationInProgress: {
          subtitle: "Vi uppdaterar tillg\xE4ngliga roller. N\xE4r det \xE4r klart kommer du att kunna uppdatera roller igen.",
          title: "Roller \xE4r tillf\xE4lligt l\xE5sta"
        }
      },
  ...
  signIn: {
    ...
    emailLinkMfa: {
      formSubtitle: "Anv\xE4nd verifieringsl\xE4nken som skickades till din e-post",
      resendButton: "Fick du inte l\xE4nken? Skicka igen",
      subtitle: "f\xF6r att forts\xE4tta till {{applicationName}}",
      title: "Kontrollera din e-post"
    },
    ...
    newDeviceVerificationNotice: "Du loggar in fr\xE5n en ny enhet. Vi ber om verifiering f\xF6r att h\xE5lla ditt konto s\xE4kert.",
    noAvailableMethods: {
    ...
    web3Solana: {
      subtitle: "V\xE4lj en pl\xE5nbok nedan f\xF6r att logga in",
  ...
  signUp: {
    ...
    web3Solana: {
      subtitle: "V\xE4lj en pl\xE5nbok nedan f\xF6r att registrera dig",
  ...
  taskChooseOrganization: {
    alerts: {
      organizationAlreadyExists: "En organisation finns redan f\xF6r det uppt\xE4ckta f\xF6retagsnamnet ({{organizationName}}) och {{organizationDomain}}. G\xE5 med via inbjudan."
    },
    chooseOrganization: {
      action__createOrganization: "Skapa ny organisation",
      action__invitationAccept: "G\xE5 med",
      action__suggestionsAccept: "Beg\xE4r att g\xE5 med",
      subtitle: "G\xE5 med i en befintlig organisation eller skapa en ny",
      subtitle__createOrganizationDisabled: "G\xE5 med i en befintlig organisation",
      suggestionsAcceptedLabel: "V\xE4ntar p\xE5 godk\xE4nnande",
      title: "V\xE4lj en organisation"
    },
    createOrganization: {
      formButtonReset: "Avbryt",
      formButtonSubmit: "Forts\xE4tt",
      ...
      subtitle: "Ange din organisationsinformation f\xF6r att forts\xE4tta",
      title: "Konfigurera din organisation"
    },
    organizationCreationDisabled: {
      subtitle: "Kontakta din organisationsadministrat\xF6r f\xF6r en inbjudan.",
      title: "Du m\xE5ste tillh\xF6ra en organisation"
    },
    signOut: {
      actionLink: "Logga ut",
  ...
  unstable__errors: {
    ...
    avatar_file_size_exceeded: "Filstorleken \xF6verskrider maxgr\xE4nsen p\xE5 10 MB. V\xE4nligen v\xE4lj en mindre fil.",
    avatar_file_type_invalid: "Filtypen st\xF6ds inte. V\xE4nligen ladda upp en JPG-, PNG-, GIF- eller WEBP-bild.",
    ...
    form_email_address_blocked: "Tillf\xE4lliga e-posttj\xE4nster st\xF6ds inte. Anv\xE4nd din vanliga e-postadress f\xF6r att skapa ett konto.",
    ...
    form_password_or_identifier_incorrect: "L\xF6senordet eller e-postadressen \xE4r felaktig. F\xF6rs\xF6k igen eller anv\xE4nd en annan metod.",
    ...
    form_username_needs_non_number_char: "Ditt anv\xE4ndarnamn m\xE5ste inneh\xE5lla minst ett icke-numeriskt tecken.",
    ...
    web3_signature_request_rejected: "Du avvisade signaturbeg\xE4ran. F\xF6rs\xF6k igen f\xF6r att forts\xE4tta.",
    web3_solana_signature_generation_failed: "Ett fel uppstod n\xE4r signaturen skulle genereras. F\xF6rs\xF6k igen f\xF6r att forts\xE4tta.",
    zxcvbn: {
    ...
    start: {
      ...
      web3WalletsSection: {
        ...
        web3SelectSolanaWalletScreen: {
          subtitle: "V\xE4lj en Solana-pl\xE5nbok f\xF6r att ansluta den till ditt konto.",
          title: "L\xE4gg till en Solana-pl\xE5nbok"
        }
      }
    },
    usernamePage: {
  ...
  waitlist: {
    start: {
      actionLink: "Logga in",
      actionText: "Har du redan \xE5tkomst?",
      formButton: "G\xE5 med i v\xE4ntelistan",
      subtitle: "Ange din e-postadress s\xE5 meddelar vi dig n\xE4r din plats \xE4r redo",
      title: "G\xE5 med i v\xE4ntelistan"
    },
    success: {
      message: "Du kommer att omdirigeras snart...",
      subtitle: "Vi h\xF6r av oss n\xE4r din plats \xE4r redo",
      title: "Tack f\xF6r att du gick med i v\xE4ntelistan!"
    }
  },
  web3SolanaWalletButtons: {
    connect: "Anslut med {{walletName}}",
    continue: "Forts\xE4tt med {{walletName}}",
    noneAvailable: 'Inga Solana Web3-pl\xE5nb\xF6cker uppt\xE4cktes. Installera en Web3-st\xF6dd {{ solanaWalletsLink || link("wallet extension") }}.'
  }
};
