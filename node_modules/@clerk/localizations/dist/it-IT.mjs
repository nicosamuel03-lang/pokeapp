...
var itIT = {
  ...
  taskChooseOrganization: {
    alerts: {
      organizationAlreadyExists: "Un'organizzazione esiste gi\xE0 per il nome dell'azienda rilevato ({{organizationName}}) e {{organizationDomain}}. Unisciti tramite invito."
    },
    chooseOrganization: {
  ...
  unstable__errors: {
    ...
    avatar_file_size_exceeded: "La dimensione del file supera il limite massimo di 10 MB. Scegli un file pi\xF9 piccolo.",
    ...
    form_password_or_identifier_incorrect: "La password o l'indirizzo email \xE8 errato. Riprova o usa un altro metodo.",
    ...
    web3_solana_signature_generation_failed: "Si \xE8 verificato un errore durante la generazione della firma. Riprova per continuare.",
    zxcvbn: {
  ...
  waitlist: {
    start: {
      actionLink: "Accedi",
      actionText: "Hai gi\xE0 accesso?",
      formButton: "Unisciti alla lista d'attesa",
      subtitle: "Inserisci il tuo indirizzo email e ti avviseremo quando il tuo posto sar\xE0 pronto",
      title: "Unisciti alla lista d'attesa"
    },
    success: {
      message: "Verrai reindirizzato a breve...",
      subtitle: "Ti contatteremo quando il tuo posto sar\xE0 pronto",
