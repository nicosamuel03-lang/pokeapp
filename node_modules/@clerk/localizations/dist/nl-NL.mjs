...
var nlNL = {
  ...
  taskChooseOrganization: {
    alerts: {
      organizationAlreadyExists: "Er bestaat al een organisatie voor de gedetecteerde bedrijfsnaam ({{organizationName}}) en {{organizationDomain}}. Word lid via uitnodiging."
    },
    chooseOrganization: {
  ...
  unstable__errors: {
    ...
    form_username_needs_non_number_char: "Uw gebruikersnaam moet minstens \xE9\xE9n niet-numeriek teken bevatten.",
