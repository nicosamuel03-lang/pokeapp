...
var ptBR = {
    ...
    membersPage: {
      ...
      alerts: {
        roleSetMigrationInProgress: {
          subtitle: "Estamos atualizando as fun\xE7\xF5es dispon\xEDveis. Assim que isso for conclu\xEDdo, voc\xEA poder\xE1 atualizar as fun\xE7\xF5es novamente.",
          title: "As fun\xE7\xF5es est\xE3o temporariamente bloqueadas"
        }
      },
  ...
  organizationSwitcher: {
    action__closeOrganizationSwitcher: "Fechar seletor de organiza\xE7\xE3o",
    action__createOrganization: "Criar organiza\xE7\xE3o",
    action__invitationAccept: "Participar",
    action__manageOrganization: "Gerenciar organiza\xE7\xE3o",
    action__openOrganizationSwitcher: "Abrir seletor de organiza\xE7\xE3o",
    action__suggestionsAccept: "Solicitar participa\xE7\xE3o",
  ...
  signIn: {
    ...
    emailLinkMfa: {
      formSubtitle: "Use o link de verifica\xE7\xE3o enviado para o seu e-mail",
      resendButton: "N\xE3o recebeu o link? Reenviar",
    ...
    newDeviceVerificationNotice: "Voc\xEA est\xE1 entrando de um novo dispositivo. Estamos solicitando verifica\xE7\xE3o para manter sua conta segura.",
    noAvailableMethods: {
    ...
    passwordUntrusted: {
      title: "Senha n\xE3o confi\xE1vel"
    },
    phoneCode: {
      formTitle: "C\xF3digo de verifica\xE7\xE3o",
      resendButton: "Reenviar c\xF3digo",
  ...
  taskChooseOrganization: {
    alerts: {
      organizationAlreadyExists: "Uma organiza\xE7\xE3o j\xE1 existe para o nome da empresa detectado ({{organizationName}}) e {{organizationDomain}}. Entre por convite."
    },
    chooseOrganization: {
      ...
      subtitle__createOrganizationDisabled: "Junte-se a uma organiza\xE7\xE3o existente",
      suggestionsAcceptedLabel: "Aprova\xE7\xE3o pendente",
    ...
    organizationCreationDisabled: {
      subtitle: "Entre em contato com o administrador da sua organiza\xE7\xE3o para obter um convite.",
      title: "Voc\xEA deve pertencer a uma organiza\xE7\xE3o"
    },
    signOut: {
      actionLink: "Sair",
  ...
  unstable__errors: {
    ...
    avatar_file_size_exceeded: "O tamanho do arquivo excede o limite m\xE1ximo de 10 MB. Por favor, escolha um arquivo menor.",
    avatar_file_type_invalid: "Tipo de arquivo n\xE3o suportado. Por favor, envie uma imagem JPG, PNG, GIF ou WEBP.",
    ...
    form_email_address_blocked: "Servi\xE7os de e-mail tempor\xE1rios n\xE3o s\xE3o suportados. Por favor, use seu endere\xE7o de e-mail regular para criar uma conta.",
    ...
    form_new_password_matches_current: "A nova senha n\xE3o pode ser igual \xE0 senha atual.",
    ...
    form_password_or_identifier_incorrect: "A senha ou o endere\xE7o de e-mail est\xE1 incorreto. Tente novamente ou use outro m\xE9todo.",
    ...
    form_password_untrusted__sign_in: "Sua senha pode estar comprometida. Para proteger sua conta, continue com um m\xE9todo de login alternativo. Voc\xEA precisar\xE1 redefinir sua senha ap\xF3s o login.",
    ...
    form_username_needs_non_number_char: "Nome de usu\xE1rio deve conter pelo menos um caractere n\xE3o n\xFAmero.",
    ...
    web3_signature_request_rejected: "Voc\xEA rejeitou a solicita\xE7\xE3o de assinatura. Tente novamente para continuar.",
    ...
    start: {
      ...
      web3WalletsSection: {
        ...
        web3SelectSolanaWalletScreen: {
          subtitle: "Selecione uma carteira Solana para conectar \xE0 sua conta.",
  ...
  web3SolanaWalletButtons: {
    ...
    noneAvailable: 'Nenhuma carteira Solana Web3 foi detectada. Instale uma {{ solanaWalletsLink || link("wallet extension") }} compat\xEDvel com Web3.'
  }
};
