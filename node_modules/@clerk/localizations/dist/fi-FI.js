...
var fiFI = {
  locale: "fi-FI",
  apiKeys: {
    action__add: "Lis\xE4\xE4 uusi avain",
    ...
    detailsTitle__emptyRow: "API-avaimia ei l\xF6ytynyt",
    formButtonPrimary__add: "Luo avain",
    formFieldCaption__expiration__expiresOn: "Vanhenee {{ date }}",
    formFieldCaption__expiration__never: "T\xE4m\xE4 avain ei vanhene koskaan",
    formFieldOption__expiration__180d: "180 p\xE4iv\xE4\xE4",
    formFieldOption__expiration__1d: "1 p\xE4iv\xE4",
    formFieldOption__expiration__1y: "1 vuosi",
    formFieldOption__expiration__30d: "30 p\xE4iv\xE4\xE4",
    formFieldOption__expiration__60d: "60 p\xE4iv\xE4\xE4",
    formFieldOption__expiration__7d: "7 p\xE4iv\xE4\xE4",
    formFieldOption__expiration__90d: "90 p\xE4iv\xE4\xE4",
    ...
    formTitle: "Lis\xE4\xE4 uusi API-avain",
    ...
    revokeConfirmation: {
      ...
      formHint: "Haluatko varmasti poistaa t\xE4m\xE4n salaisen avaimen?",
      formTitle: 'Peruuttaako "{{apiKeyName}}" salainen avain?'
    }
  },
  backButton: "Takaisin",
  badge__activePlan: "Aktiivinen",
  badge__canceledEndsAt: "Peruutettu \u2022 P\xE4\xE4ttyy {{ date | shortDate('fi-FI') }}",
  badge__currentPlan: "Nykyinen paketti",
  badge__default: "Oletus",
  badge__endsAt: "P\xE4\xE4ttyy {{ date | shortDate('fi-FI') }}",
  badge__expired: "Vanhentunut",
  badge__freeTrial: "Ilmainen kokeilu",
  badge__otherImpersonatorDevice: "Toinen j\xE4ljitelty laite",
  badge__pastDueAt: "Er\xE4\xE4ntynyt {{ date | shortDate('fi-FI') }}",
  badge__pastDuePlan: "Er\xE4\xE4ntynyt",
  ...
  badge__trialEndsAt: "Kokeilu p\xE4\xE4ttyy {{ date | shortDate('fi-FI') }}",
  badge__unverified: "Vahvistamaton",
  badge__upcomingPlan: "Tuleva",
  badge__userDevice: "K\xE4ytt\xE4j\xE4n laite",
  badge__you: "Sin\xE4",
  billing: {
    addPaymentMethod__label: "Lis\xE4\xE4 maksutapa",
    alwaysFree: "Aina ilmainen",
    annually: "Vuosittain",
    availableFeatures: "Sis\xE4ltyv\xE4t ominaisuudet",
    ...
    cancelFreeTrialAccessUntil: "Kokeilusi pysyy aktiivisena {{ date | longDate('fi-FI') }} asti. T\xE4m\xE4n j\xE4lkeen menet\xE4t p\xE4\xE4syn kokeiluominaisuuksiin. Sinulta ei veloiteta.",
    cancelFreeTrialTitle: "Peruuttaako {{plan}}-paketin ilmainen kokeilu?",
    cancelSubscription: "Peruuta tilaus",
    cancelSubscriptionAccessUntil: "Voit k\xE4ytt\xE4\xE4 '{{plan}}' ominaisuuksia {{ date | longDate('fi-FI') }} asti, mink\xE4 j\xE4lkeen p\xE4\xE4sy p\xE4\xE4ttyy.",
    cancelSubscriptionNoCharge: "Tilauksesta ei veloiteta.",
    cancelSubscriptionPastDue: "Tilauksesi p\xE4\xE4ttyy v\xE4litt\xF6m\xE4sti ja menet\xE4t p\xE4\xE4syn kaikkiin tilauksen ominaisuuksiin. Sinulta pyydet\xE4\xE4n maksamaan er\xE4\xE4ntynyt summa seuraavassa tilauksessa.",
    cancelSubscriptionTitle: "Peruuttaako {{plan}}-tilauksen?",
    cannotSubscribeMonthly: "Et voi tilata t\xE4t\xE4 pakettia kuukausimaksulla. Tilataksesi t\xE4m\xE4n sinun on valittava vuositilaus.",
    cannotSubscribeUnrecoverable: "Et voi tilata t\xE4t\xE4 pakettia. Nykyinen tilauksesi on kalliimpi kuin t\xE4m\xE4 paketti.",
    checkout: {
      description__paymentSuccessful: "Maksusi onnistui.",
      description__subscriptionSuccessful: "Uusi tilauksesi on valmis.",
      downgradeNotice: "S\xE4ilyt\xE4t nykyisen tilauksesi ja sen ominaisuudet laskutuskauden loppuun asti, mink\xE4 j\xE4lkeen siirryt t\xE4h\xE4n tilaukseen.",
      emailForm: {
        subtitle: "Ennen ostoksen viimeistely\xE4 sinun on lis\xE4tt\xE4v\xE4 s\xE4hk\xF6postiosoite, johon kuitit l\xE4hetet\xE4\xE4n.",
        title: "Lis\xE4\xE4 s\xE4hk\xF6postiosoite"
      },
      lineItems: {
        title__freeTrialEndsAt: "Kokeilu p\xE4\xE4ttyy",
        title__paymentMethod: "Maksutapa",
        title__statementId: "Tositenumero",
        title__subscriptionBegins: "Tilaus alkaa",
        title__totalPaid: "Maksettu yhteens\xE4"
      },
      pastDueNotice: "Edellinen tilauksesi oli er\xE4\xE4ntynyt eik\xE4 maksua ole suoritettu.",
      ...
      totalDueAfterTrial: "Er\xE4\xE4ntyy kokeilun p\xE4\xE4tytty\xE4 {{days}} p\xE4iv\xE4n kuluttua"
    },
    credit: "Hyvitys",
    creditRemainder: "Hyvitys nykyisen tilauksesi j\xE4ljell\xE4 olevalta ajalta.",
    defaultFreePlanActive: "Olet t\xE4ll\xE4 hetkell\xE4 ilmaisella tilauksella.",
    free: "Ilmainen",
    getStarted: "Aloita",
    keepFreeTrial: "Pid\xE4 ilmainen kokeilu",
    keepSubscription: "Pid\xE4 tilaus",
    manage: "Hallinnoi",
    manageSubscription: "Hallinnoi tilausta",
    month: "Kuukausi",
    monthly: "Kuukausittain",
    pastDue: "Er\xE4\xE4ntynyt",
    pay: "Maksa {{amount}}",
    paymentMethod: {
      applePayDescription: {
        annual: "Vuosimaksu",
    ...
    seeAllFeatures: "N\xE4yt\xE4 kaikki ominaisuudet",
    startFreeTrial: "Aloita ilmainen kokeilu",
    startFreeTrial__days: "Aloita {{days}} p\xE4iv\xE4n ilmainen kokeilu",
    subscribe: "Tilaa",
    subscriptionDetails: {
      beginsOn: "Alkaa",
      currentBillingCycle: "Nykyinen laskutusjakso",
      endsOn: "P\xE4\xE4ttyy",
      firstPaymentAmount: "Ensimm\xE4inen maksu",
      firstPaymentOn: "Ensimm\xE4inen maksu",
      nextPaymentAmount: "Seuraava maksu",
      nextPaymentOn: "Seuraava maksu",
      pastDueAt: "Er\xE4\xE4ntynyt",
      renewsAt: "Uusitaan",
      subscribedOn: "Tilattu",
      title: "Tilaus",
      trialEndsOn: "Kokeilu p\xE4\xE4ttyy",
      trialStartedOn: "Kokeilu alkanut"
    },
    subtotal: "V\xE4lisumma",
    switchPlan: "Vaihda t\xE4h\xE4n tilaukseen",
    ...
    totalDue: "Maksettava yhteens\xE4",
    totalDueToday: "Maksettava t\xE4n\xE4\xE4n",
    viewFeatures: "N\xE4yt\xE4 ominaisuudet",
    viewPayment: "N\xE4yt\xE4 maksu",
    year: "Vuosi"
  },
  createOrganization: {
  ...
  dividerText: "tai",
  footerActionLink__alternativePhoneCodeProvider: "L\xE4het\xE4 koodi tekstiviestill\xE4",
  ...
  formFieldInputPlaceholder__apiKeyDescription: "Sy\xF6t\xE4 selite API-avaimelle",
  formFieldInputPlaceholder__apiKeyExpirationDate: "Valitse p\xE4iv\xE4m\xE4\xE4r\xE4",
  formFieldInputPlaceholder__apiKeyName: "Sy\xF6t\xE4 API-avaimen nimi",
  formFieldInputPlaceholder__backupCode: "Sy\xF6t\xE4 varakoodi",
  formFieldInputPlaceholder__confirmDeletionUserAccount: "Poista tili",
  formFieldInputPlaceholder__emailAddress: "Sy\xF6t\xE4 s\xE4hk\xF6postiosoitteesi",
  formFieldInputPlaceholder__emailAddress_username: "Sy\xF6t\xE4 k\xE4ytt\xE4j\xE4nimi tai s\xE4hk\xF6postiosoite",
  ...
  formFieldInputPlaceholder__password: "Sy\xF6t\xE4 salasanasi",
  formFieldInputPlaceholder__phoneNumber: "Sy\xF6t\xE4 puhelinnumerosi",
  ...
  organizationProfile: {
    ...
    billingPage: {
      paymentHistorySection: {
        ...
        notFound: "Maksuyrityst\xE4 ei l\xF6ytynyt",
        tableHeader__amount: "Summa",
        tableHeader__date: "P\xE4iv\xE4m\xE4\xE4r\xE4",
        tableHeader__status: "Tila"
      },
      paymentMethodsSection: {
        actionLabel__default: "Aseta oletukseksi",
        actionLabel__remove: "Poista",
        add: "Lis\xE4\xE4 uusi maksutapa",
        addSubtitle: "Lis\xE4\xE4 uusi maksutapa tilillesi.",
        cancelButton: "Peruuta",
        formButtonPrimary__add: "Lis\xE4\xE4 maksutapa",
        formButtonPrimary__pay: "Maksa {{amount}}",
        payWithTestCardButton: "Maksa testikortilla",
        removeMethod: {
          messageLine1: "{{identifier}} poistetaan t\xE4lt\xE4 tililt\xE4.",
          messageLine2: "Et voi en\xE4\xE4 k\xE4ytt\xE4\xE4 t\xE4t\xE4 maksutapaa, ja siihen sidotut toistuvat tilaukset lakkaavat toimimasta.",
          successMessage: "{{paymentMethod}} on poistettu tililt\xE4si.",
      ...
      statementsSection: {
        empty: "Ei tositteita n\xE4ytett\xE4v\xE4ksi",
        itemCaption__paidForPlan: "Maksettu {{plan}} {{period}} -tilauksesta",
        itemCaption__proratedCredit: "Suhteutettu hyvitys edellisen tilauksen osittaisesta k\xE4yt\xF6st\xE4",
        itemCaption__subscribedAndPaidForPlan: "Tilattu ja maksettu {{plan}} {{period}} -tilaus",
        notFound: "Tosite ei l\xF6ytynyt",
        tableHeader__amount: "Summa",
        tableHeader__date: "P\xE4iv\xE4m\xE4\xE4r\xE4",
        title: "Tositteet",
        totalPaid: "Maksettu yhteens\xE4"
      },
      subscriptionsListSection: {
        ...
        tableHeader__startDate: "Aloitusp\xE4iv\xE4",
        title: "Tilaus"
      },
    ...
    membersPage: {
      ...
      alerts: {
        roleSetMigrationInProgress: {
          subtitle: "P\xE4ivit\xE4mme k\xE4ytett\xE4viss\xE4 olevia rooleja. Kun se on tehty, voit p\xE4ivitt\xE4\xE4 rooleja uudelleen.",
          title: "Roolit on tilap\xE4isesti lukittu"
        }
      },
    ...
    plansPage: {
      alerts: {
        noPermissionsToManageBilling: "Sinulla ei ole oikeuksia hallinnoida t\xE4m\xE4n organisaation laskutusta."
      },
      title: "Tilaukset"
    },
    profilePage: {
  ...
  reverification: {
    alternativeMethods: {
      actionLink: "Hae apua",
      actionText: "Eik\xF6 mik\xE4\xE4n n\xE4ist\xE4 ole k\xE4ytett\xE4viss\xE4?",
      blockButton__backupCode: "K\xE4yt\xE4 varakoodia",
      blockButton__emailCode: "L\xE4het\xE4 koodi s\xE4hk\xF6postitse {{identifier}}",
      blockButton__passkey: "K\xE4yt\xE4 p\xE4\xE4syavaintasi",
      blockButton__password: "Jatka salasanallasi",
      blockButton__phoneCode: "L\xE4het\xE4 SMS-koodi {{identifier}}",
      blockButton__totp: "K\xE4yt\xE4 todennussovellustasi",
      getHelp: {
        blockButton__emailSupport: "S\xE4hk\xF6postituki",
        content: "Jos sinulla on ongelmia tilisi vahvistamisessa, l\xE4het\xE4 meille s\xE4hk\xF6postia, niin autamme sinua palauttamaan p\xE4\xE4syn mahdollisimman pian.",
        title: "Hae apua"
      },
      subtitle: "Ongelmia? Voit k\xE4ytt\xE4\xE4 mit\xE4 tahansa n\xE4ist\xE4 vahvistusmenetelmist\xE4.",
      title: "K\xE4yt\xE4 toista menetelm\xE4\xE4"
    },
    backupCodeMfa: {
      subtitle: "Sy\xF6t\xE4 varakoodi, jonka sait kaksivaiheista todennusta asettaessasi",
    ...
    noAvailableMethods: {
      message: "Vahvistusta ei voida suorittaa. Sopivaa todennusmenetelm\xE4\xE4 ei ole m\xE4\xE4ritetty.",
      subtitle: "Tapahtui virhe",
      title: "Tili\xE4 ei voi vahvistaa"
    },
    passkey: {
      blockButton__passkey: "K\xE4yt\xE4 p\xE4\xE4syavaintasi",
      subtitle: "P\xE4\xE4syavaimen k\xE4ytt\xF6 vahvistaa henkil\xF6llisyytesi. Laitteesi saattaa pyyt\xE4\xE4 sormenj\xE4lke\xE4, kasvoja tai n\xE4yt\xF6n lukitusta.",
      title: "K\xE4yt\xE4 p\xE4\xE4syavaintasi"
    },
    password: {
      actionLink: "K\xE4yt\xE4 toista menetelm\xE4\xE4",
      subtitle: "Sy\xF6t\xE4 nykyinen salasanasi jatkaaksesi",
      title: "Vahvistus vaaditaan"
    },
    phoneCode: {
      formTitle: "Vahvistuskoodi",
    ...
    totpMfa: {
      formTitle: "Vahvistuskoodi",
      subtitle: "Sy\xF6t\xE4 todennussovelluksesi luoma koodi jatkaaksesi",
      title: "Vahvistus vaaditaan"
    }
  },
  signIn: {
    ...
    alternativeMethods: {
      actionLink: "Ota yhteytt\xE4 ongelmatilanteissa",
      ...
      getHelp: {
        ...
        title: "Ota yhteytt\xE4 ongelmatilanteissa"
      },
    ...
    emailCodeMfa: {
      formTitle: "Tarkista s\xE4hk\xF6postisi",
      resendButton: "Etk\xF6 saanut koodia? L\xE4het\xE4 uudelleen",
      subtitle: "jatkaaksesi kohteeseen {{applicationName}}",
      title: "Tarkista s\xE4hk\xF6postisi"
    },
    ...
    newDeviceVerificationNotice: "Kirjaudut sis\xE4\xE4n uudesta laitteesta. Pyyd\xE4mme vahvistusta tilisi turvallisuuden varmistamiseksi.",
    noAvailableMethods: {
    ...
    start: {
      ...
      actionText__join_waitlist: "Haluatko varhaisen p\xE4\xE4syn?",
      alternativePhoneCodeProvider: {
        actionLink: "K\xE4yt\xE4 toista tapaa",
        label: "{{provider}}-puhelinnumero",
        subtitle: "Sy\xF6t\xE4 puhelinnumerosi saadaksesi vahvistuskoodin {{provider}} kautta.",
        title: "Kirjaudu {{applicationName}}-palveluun {{provider}} avulla"
      },
      subtitle: "Tervetuloa takaisin! Kirjaudu sis\xE4\xE4n jatkaaksesi",
    ...
    web3Solana: {
      ...
      title: "Kirjaudu sis\xE4\xE4n Solanalla"
    }
  },
  ...
  signUp: {
    alternativePhoneCodeProvider: {
      resendButton: "Etk\xF6 saanut koodia? L\xE4het\xE4 uudelleen",
      subtitle: "Sy\xF6t\xE4 {{provider}}-palveluun l\xE4hetetty vahvistuskoodi",
    ...
    restrictedAccess: {
      ...
      subtitle: "Rekister\xF6ityminen on t\xE4ll\xE4 hetkell\xE4 pois k\xE4yt\xF6st\xE4. Jos uskot, ett\xE4 sinulla pit\xE4isi olla p\xE4\xE4sy, ota yhteytt\xE4 tukeen.",
      subtitleWaitlist: "Rekister\xF6ityminen on t\xE4ll\xE4 hetkell\xE4 pois k\xE4yt\xF6st\xE4. Liity jonotuslistalle saadaksesi tiedon heti kun palvelu avautuu.",
      title: "P\xE4\xE4sy rajoitettu"
    },
    start: {
      actionLink: "Kirjaudu sis\xE4\xE4n",
      actionLink__use_email: "K\xE4yt\xE4 s\xE4hk\xF6postia",
      ...
      alternativePhoneCodeProvider: {
        ...
        label: "{{provider}}-puhelinnumero",
        subtitle: "Sy\xF6t\xE4 puhelinnumerosi saadaksesi vahvistuskoodin {{provider}} kautta.",
        title: "Rekister\xF6idy {{applicationName}}-palveluun {{provider}} avulla"
      },
    ...
    web3Solana: {
      subtitle: "Valitse alta lompakko rekister\xF6itymist\xE4 varten",
      title: "Rekister\xF6idy Solanalla"
    }
  },
  ...
  taskChooseOrganization: {
    alerts: {
      organizationAlreadyExists: "Organisaatio on jo olemassa havaitulle yrityksen nimelle ({{organizationName}}) ja {{organizationDomain}}. Liity kutsulla."
    },
    chooseOrganization: {
    ...
    createOrganization: {
      ...
      subtitle: "Sy\xF6t\xE4 organisaation tiedot jatkaaksesi",
      title: "M\xE4\xE4rit\xE4 organisaatiosi"
    },
    ...
    signOut: {
      ...
      actionText: "Kirjautuneena k\xE4ytt\xE4j\xE4n\xE4 {{identifier}}"
    }
  },
  taskResetPassword: {
    formButtonPrimary: "Nollaa salasana",
  ...
  unstable__errors: {
    already_a_member_in_organization: "{{email}} on jo t\xE4m\xE4n organisaation j\xE4sen.",
    avatar_file_size_exceeded: "Tiedostokoko ylitt\xE4\xE4 enimm\xE4israjan 10 Mt. Valitse pienempi tiedosto.",
    avatar_file_type_invalid: "Tiedostotyyppi\xE4 ei tueta. Lataa JPG-, PNG-, GIF- tai WEBP-kuva.",
    ...
    form_email_address_blocked: "V\xE4liaikaiset s\xE4hk\xF6postipalvelut eiv\xE4t ole tuettuja. K\xE4yt\xE4 tavallista s\xE4hk\xF6postiosoitetta tilin luomiseen.",
    ...
    form_password_or_identifier_incorrect: "Salasana tai s\xE4hk\xF6postiosoite on v\xE4\xE4r\xE4. Yrit\xE4 uudelleen tai k\xE4yt\xE4 toista menetelm\xE4\xE4.",
    ...
    form_username_needs_non_number_char: "K\xE4ytt\xE4j\xE4nimess\xE4 tulee olla v\xE4hint\xE4\xE4n yksi ei-numeerinen merkki.",
    ...
    organization_not_found_or_unauthorized: "Et ole en\xE4\xE4 t\xE4m\xE4n organisaation j\xE4sen. Valitse tai luo toinen organisaatio.",
    organization_not_found_or_unauthorized_with_create_organization_disabled: "Et ole en\xE4\xE4 t\xE4m\xE4n organisaation j\xE4sen. Valitse toinen organisaatio.",
    ...
    web3_missing_identifier: "Web3-lompakkoa ei l\xF6ytynyt. Asenna sellainen jatkaaksesi.",
    web3_signature_request_rejected: "Hylk\xE4sit allekirjoituspyynn\xF6n. Yrit\xE4 uudelleen jatkaaksesi.",
    web3_solana_signature_generation_failed: "Allekirjoitusta luotaessa tapahtui virhe. Yrit\xE4 uudelleen jatkaaksesi.",
    zxcvbn: {
  ...
  userButton: {
    action__addAccount: "Lis\xE4\xE4 tili",
    action__closeUserMenu: "Sulje k\xE4ytt\xE4j\xE4valikko",
    action__manageAccount: "Hallitse tili\xE4",
    action__openUserMenu: "Avaa k\xE4ytt\xE4j\xE4valikko",
    action__signOut: "Kirjaudu ulos",
    action__signOutAll: "Kirjaudu ulos kaikilta tileilt\xE4"
  },
  userProfile: {
    apiKeysPage: {
      title: "API-avaimet"
    ...
    emailAddressPage: {
      ...
      enterpriseSSOLink: {
        formButton: "Kirjaudu sis\xE4\xE4n",
        formSubtitle: "Viimeistele kirjautuminen {{identifier}} avulla"
      },
      formHint: "Sinun on vahvistettava t\xE4m\xE4 s\xE4hk\xF6postiosoite ennen kuin se voidaan lis\xE4t\xE4 tilillesi.",
      removeResource: {
        messageLine1: "{{identifier}} poistetaan tililt\xE4si.",
    ...
    start: {
      ...
      connectedAccountsSection: {
        ...
        subtitle__disconnected: "T\xE4m\xE4n tilin liitos on katkaistu.",
      ...
      passkeysSection: {
        ...
        primaryButton: "Lis\xE4\xE4 p\xE4\xE4syavain",
      ...
      web3WalletsSection: {
        ...
        detailsAction__nonPrimary: "Aseta ensisijaiseksi",
        primaryButton: "Yhdist\xE4 lompakko",
        title: "Web3-lompakot",
        web3SelectSolanaWalletScreen: {
          subtitle: "Valitse Solana-lompakko yhdistett\xE4v\xE4ksi tiliisi.",
          title: "Lis\xE4\xE4 Solana-lompakko"
        }
      }
    },
    usernamePage: {
  ...
  waitlist: {
    start: {
      actionLink: "Kirjaudu sis\xE4\xE4n",
      actionText: "Onko sinulla jo p\xE4\xE4sy?",
      formButton: "Liity jonotuslistalle",
      subtitle: "Sy\xF6t\xE4 s\xE4hk\xF6postiosoitteesi ja ilmoitamme sinulle, kun paikkasi on valmis",
      title: "Liity jonotuslistalle"
    },
    success: {
      message: "Sinut ohjataan pian...",
      subtitle: "Otamme yhteytt\xE4, kun paikkasi on valmis",
      title: "Kiitos liittymisest\xE4 jonotuslistalle!"
    }
  },
  web3SolanaWalletButtons: {
    connect: "Yhdist\xE4 {{walletName}}",
